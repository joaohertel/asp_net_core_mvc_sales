...
namespace SalesMVC.Data
{
    ...
    {
        public SalesMVCContext _context;
        ...
        public void Seed()
        {
            Console.WriteLine($"Rodando seeding service");

            // Instanciar objetos com valores para fazer o seed da base
            ...
            {
                return; // encerrando a execucao caso ja existam registros
            }

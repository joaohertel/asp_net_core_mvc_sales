...
namespace SalesMVC.Migrations
{
    ...
    [Migration("20230709020729_Adicionando Restrição de Chave Estrangeira em Seller via int")]
    partial class AdicionandoRestriçãodeChaveEstrangeiraemSellerviaint
    {
        /// <inheritdoc />
